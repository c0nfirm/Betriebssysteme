 ...
 * @endcode
 * 
 * Auch strukturierte Daten können auf diese Weise als Array organisiert werden.
 * Eine Einschränkung ist, dass man keine Zeiger auf Arrayelemente halten
 * sollte, da das Array beim Einfügen neuer Elemente möglicherweise
 * relokalisiert werden muss, was alle Zeiger auf Elemente invalidiert. Um auf
 * Elemente zu verweisen sollten Indizes verwendet werden, es sei denn du weißt
 * was du tust!
 ******************************************************************************/
 ...
 * @param self  der freizugebende Array
 */
 ...
 */
extern size_t arrayCount(const void* self);
